using Test
using Paulimorphic
using Paulimorphic: posImg, negRea, negImg, mul
...
@testset "toMajoranaPair" begin
    ...
    #> `op` passes the adjoint and identity checks, but `op^2 == (12//25)I != 0`, so only 
    #> the self-anticommutation branch can reject it
